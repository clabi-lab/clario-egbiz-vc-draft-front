  ...
  return (
    <div className={mergeClassNames(className, "w-[20px] h-[20px]")}>
      ...
      >
        ...
        />
        <path
          d="M13.8867 7.11827C14.2867 7.40994 14.6201 7.82994 14.8517 8.3366C15.0826 8.84244 15.2051 9.41577 15.2051 9.99994C15.2051 10.5833 15.0826 11.1583 14.8517 11.6633C14.6201 12.1691 14.2876 12.5899 13.8867 12.8816M15.5834 5.35327C16.2292 5.8241 16.7667 6.50161 17.1392 7.31744C17.5117 8.13244 17.7084 9.05827 17.7084 9.99994C17.7084 10.9416 17.5117 11.8666 17.1392 12.6833C16.7659 13.4983 16.2292 14.1758 15.5834 14.6466"
          stroke="#777777"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
